    ...
    def _check_quality(password: str, charset: str) -> bool:
        ...
        if len(password) >= MIN_PASSWORD_LENGTH:
            ...
            for _, type_chars in char_types.items():
                if any(c in type_chars for c in charset) and any(
                    c in type_chars for c in password
            ...
            MIN_REQUIRED_TYPES = 2
            if available_types >= MIN_REQUIRED_TYPES and len(present_types) < MIN_REQUIRED_TYPES:
                return False
