...
from config import SIGN_METADATA
...
def encrypt_hidden_volume():
    """
    Creates a hidden volume (real + decoy) with plausible deniability.
    """
    clear_screen()
    ...
    # Outer meta (decoy-side metadata)
    outer_meta = {
...
def decrypt_file(encrypted_file: str, outer_password: bytearray):
    ...
    if is_hidden:
        ...
        # Verifica assinatura de autenticidade se presente
        ...
        # Normal volume (delegar para single_shot/streaming)
