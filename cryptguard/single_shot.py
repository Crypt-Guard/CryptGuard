...
def encrypt_data_single(data: bytes, password: bytearray, file_type: str,
    ...
    """
    Usa Argon2 p/ derivar chave do arquivo, criptografa em 1 chunk, com AAD,
    e salva. Salva metadata (salt, params) cifrado via .meta.
    """
...
def decrypt_data_single(enc_path: str, password: bytearray):
    """
    Decifra .meta para obter salt e params; decifra 1 chunk do arquivo.
    Gera o nome de saída usando 'original_ext' se presente.
    """
    ...
    try:
        ...
        out_name = (
            ...
            f'{meta_plain.get("original_ext","")}'  # ← usa a extensão original se existir
        )
